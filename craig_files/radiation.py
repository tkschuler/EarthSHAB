...
import properties.config_earth as config_earth
...
class Radiation:
    ...
    def get_zenith(self, t, coord):
        ...
        solpos = fluids.solar_position(t, coord["lat"], coord["lon"], Z = coord["alt_m"])
        ...
        elevationAdjustment = math.acos(earthRadius / (earthRadius + (coord["alt_m"]/1000.)));
